...
SYSTEM_NAME = "Shiina Mahiru"
MODEL_BADGE = "SHIINA CORE"
...
class JarvisUI:
    def __init__(self, face_path, size=None):
        self.root = tk.Tk()
        self.root.title("Shiina Mahiru — SHIINA CORE")
    ...
    def _draw(self):
        ...
        c.create_text(W // 2, H - 14, fill=C_DIM, font=("Courier", 8),
                      text="Shiina Core  ·  LOCAL ASSISTANT  ·  BUILD")
    ...
    def wait_for_api_key(self):
        """Block until API key is saved (called from main thread before starting Shiina)."""
    ...
    def _show_setup_ui(self):
        ...
        tk.Label(self.setup_frame,
                 text="Enter your Gemini API key to boot Shiina Mahiru.",
    ...
    def _save_api_keys(self):
        ...
        self.status_text = "ONLINE"
        self.write_log("SYS: Systems initialised. Shiina Mahiru online.")
